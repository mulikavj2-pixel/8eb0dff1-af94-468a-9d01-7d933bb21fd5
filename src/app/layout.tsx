...
export const metadata: Metadata = {
  title: "AutoDrive - Premium Used & New Cars | Car Dealership",
  description: "Discover premium vehicles at AutoDrive. Browse new and used cars with transparent pricing, expert support, and flexible financing options.",
  keywords: "car dealership, used cars, new cars, vehicle sales, auto sales, car sales",
  metadataBase: new URL("https://autodrive.com"),
  alternates: {
    canonical: "https://autodrive.com"
  },
  openGraph: {
    title: "AutoDrive - Find Your Perfect Vehicle",
    description: "Browse premium selection of new and used vehicles with expert support and transparent pricing.",
    siteName: "AutoDrive",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765896185387-8oi4eezz.jpg",
  ...
  twitter: {
    ...
    title: "AutoDrive - Premium Car Dealership",
    description: "Discover your perfect vehicle with AutoDrive's premium selection",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765896185387-8oi4eezz.jpg"]
  },
  robots: {
    index: true,
    follow: true
